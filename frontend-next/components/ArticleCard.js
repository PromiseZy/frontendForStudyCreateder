function ArticleCard(props){
    ...
    return(
        ...
        <div className="">
            <div className="bg-white mt-2 shadow rounded-lg	" style={{width: "288px", height: "449px", fontFamily: 'Noto Sans Thai, sans-serif'}}>
                ...
                <div className="py-4 text-center font-black" style={{width: "100%", height: "50px"}}>
                    <p>{props.props.attributes.title}</p>
                </div>
                <div className="py-4 px-2 font-light" style={{width: "100%", height: "137px"}}>
                    <p>{props.props.attributes.intro}</p>
                </div>
                <div className="py-4 text-center" style={{width: "100%", height: "50px"}}>
